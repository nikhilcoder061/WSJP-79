...
export default function EditProduct() {
    ...
    const { fetchAllCategory, fetchAllColor, fetchAllProduct,
        allColor, allCategory, allProduct,
        API_BASE_URL, PRODUCT_URL, toastNotify } = useContext(MainContext);
    ...
    const editProduct = (event) => {
        ...
        axios.put(API_BASE_URL + PRODUCT_URL + "/edit/" + product_id, formData).then(
            (success) => {
    ...
    return (
        <div className="max-w-6xl mx-auto bg-white p-6 rounded-lg mt-2 border">
            ...
            <form className="grid grid-cols-3 gap-6" onSubmit={editProduct}>
                <div>
                ...
                <div>
                    ...
                    <input
                        ...
                        required=""
                    />
                    <img src={API_BASE_URL + `/images/product/${allProduct.main_image}`} alt="" className='w-10' />
                </div>
